...
class CardDataSource extends DataGridSource {
  ...
  CardDataSource(
    ...
    dataGridRows =
        CardList.map<DataGridRow>((dataGridRow) => DataGridRow(cells: [
              ...
              DataGridCell<String>(
                  columnName: 'CardImage', value: dataGridRow.cardImage),
              DataGridCell<int>(
  ...
  Widget _build_one_cell(DataGridCell oneCell) {
    return Container(
        ...
        // padding: EdgeInsets.symmetric(horizontal: 16.0),
        child: oneCell.columnName == 'image'||oneCell.columnName=='CardImage'
            ? Image.network(
                oneCell.value,
