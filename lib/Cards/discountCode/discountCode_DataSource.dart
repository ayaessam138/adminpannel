...
class DisCountCodeDataSource extends DataGridSource {
  ...
  DisCountCodeDataSource(
      {required List<DisCountCodeModel> DisCountCodeList,
    ...
    dataGridRows =
        DisCountCodeList.map<DataGridRow>((dataGridRow) => DataGridRow(cells: [
          ...
          DataGridCell<int>(
              columnName: 'DiscountType', value: dataGridRow.discountType),
          DataGridCell<int>(
              columnName: 'discountValue', value: dataGridRow.discountValue),
