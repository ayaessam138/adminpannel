...
class NationalityDataSource extends DataGridSource {
  ...
  NationalityDataSource(
      {required List<NationalityModel> NationalityList,
    ...
    dataGridRows =
        NationalityList.map<DataGridRow>((dataGridRow) => DataGridRow(cells: [
