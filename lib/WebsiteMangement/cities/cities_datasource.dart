...
class citiesDataSource extends DataGridSource {
  ...
  citiesDataSource(
    ...
    dataGridRows =
        citiesList.map<DataGridRow>((dataGridRow) => DataGridRow(cells: [
              DataGridCell<int>(columnName: 'index', value: index++),
              DataGridCell<int>(columnName: 'id', value: dataGridRow.id),
              DataGridCell<String>(columnName: 'name', value: dataGridRow.name),
              DataGridCell<String>(
                  columnName: 'name in English', value: dataGridRow.nameEn),
              DataGridCell<int>(columnName: 'region', value: dataGridRow.regionId),
              DataGridCell<int>(
                  columnName: 'status', value: dataGridRow.status),
              DataGridCell<int>(
                  columnName: 'sortat', value: dataGridRow.sortAt),
