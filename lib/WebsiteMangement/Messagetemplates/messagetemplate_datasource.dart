...
class MessagetemplateDataSource extends DataGridSource {
  ...
  MessagetemplateDataSource(
      {required List<MessagetemplateModel> MessagetemplateList,
      required this.context,
      required this.doShowDetails,
      required this.doEdit,

      required this.gridKey}) {
    dataGridRows = MessagetemplateList.map<DataGridRow>(
        (dataGridRow) => DataGridRow(cells: [
              DataGridCell<int>(columnName: 'index', value: index++),
              DataGridCell<int>(columnName: 'id', value: dataGridRow.id),
              DataGridCell<String>(columnName: 'name', value: dataGridRow.name),
              DataGridCell<String>(
                  columnName: 'name in English', value: dataGridRow.nameEn),
              DataGridCell<String>(
                  columnName: 'emailMessagetitle',
                  value: dataGridRow.emailMessagetitle),
              DataGridCell<String>(
                  columnName: 'emailMessagetitle_En',
                  value: dataGridRow.emailMessagetitle_En),
            ])).toList();
  }
