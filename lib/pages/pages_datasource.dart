...
class PagesDataSource extends DataGridSource {
  ...
  PagesDataSource(
      {required List<PagesModel> PagesList,
    ...
    dataGridRows =
        PagesList.map<DataGridRow>((dataGridRow) => DataGridRow(cells: [
              ...
              DataGridCell<String>(
                  columnName: 'Created At', value: dataGridRow.createdAt),
            ])).toList();
  }
