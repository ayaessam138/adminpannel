...
class ShowBranchesDeatils extends StatelessWidget {
  ShowBranchesDeatils({super.key, required this.BranchessModel});
  final BranchesModel BranchessModel;
  ...
  String getValueForKey(String key) {
    switch (key) {
      case "id":
        return BranchessModel.id.toString();
      case "partner_name":
        return BranchessModel.partnername;
      case "name":
        return BranchessModel.name;
      case "name_en":
        return BranchessModel.nameEn;
      case "image":
        return BranchessModel.image.toString();
      case "status":
        return BranchessModel.status.toString();
