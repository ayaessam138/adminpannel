...
class BranchesDataSource extends DataGridSource {
  ...
  BranchesDataSource(
      {required List<BranchesModel> BranchesList,
    ...
    dataGridRows =
        BranchesList.map<DataGridRow>((dataGridRow) => DataGridRow(cells: [
          DataGridCell<int>(columnName: 'index', value: index++),
          DataGridCell<int>(columnName: 'id', value: dataGridRow.id),
          DataGridCell<String>(columnName: 'partnername', value: dataGridRow.partnername),
