...
class _BreadcrumbScreenState extends State<BreadcrumbScreen> {
  List<String> _breadcrumbs = ['Home']; // Initial breadcrumb path

  void _updateBreadcrumbs(String crumb) {
    setState(() {
            ...
            children: [
              for (var i = 0; i < _breadcrumbs.length; i++)
                Row(
                  children: [
                    Text(_breadcrumbs[i]),
                    if (i != _breadcrumbs.length - 1) Icon(Icons.chevron_right),
                  ],
                ),
            ],
          ),
          ...
          child: ListView(
            children: [
              ListTile(
                ...
                onTap: () {
                  _updateBreadcrumbs('Category 1');
                },
              ),
              ListTile(
                title: Text('Subcategory 1.1'),
                onTap: () {
                  _updateBreadcrumbs('Subcategory 1.1');
                },
              ),
              ListTile(
                title: Text('Subcategory 1.2'),
                onTap: () {
                  _updateBreadcrumbs('Subcategory 1.2');
                },
              ),
            ],
          ),
