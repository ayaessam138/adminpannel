...
class PartnerDataSource extends DataGridSource {
  ...
  PartnerDataSource(
      {required List<PartnerModel> PartnerList,
    ...
    dataGridRows =
        PartnerList.map<DataGridRow>((dataGridRow) => DataGridRow(cells: [
              DataGridCell<int>(columnName: 'index', value: index++),
              DataGridCell<int>(columnName: 'id', value: dataGridRow.id),
              DataGridCell<String>(columnName: 'name', value: dataGridRow.name),
              DataGridCell<String>(
                  columnName: 'cate_name', value: dataGridRow.cate_name),
              DataGridCell<String>(columnName: 'slug', value: dataGridRow.slug),
              DataGridCell<int>(
                  columnName: 'branches_num', value: dataGridRow.branches_num),
              DataGridCell<int>(
                  columnName: 'offer_num', value: dataGridRow.offer_num),
              DataGridCell<int>(
                  columnName: 'services_num', value: dataGridRow.services_num),
              DataGridCell<int>(
