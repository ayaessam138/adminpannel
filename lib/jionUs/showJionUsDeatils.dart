...
class ShowJionUsDetails extends StatelessWidget {
  final JionUsModel JionUsbyIdModel;
  List<String> keysList = ["id", "name", "email", "mobile", "city","ceratedAt","status"];

  ShowJionUsDetails({super.key, required this.JionUsbyIdModel});
  String getValueForKey(String key) {
    switch (key) {
      case "id":
        return JionUsbyIdModel.id.toString();
      case "name":
        return JionUsbyIdModel.name;
      case "email":
        return JionUsbyIdModel.email;
      case "mobile":
        return JionUsbyIdModel.mobile;
      case "city":
        return JionUsbyIdModel.city;

      case "status":
        return JionUsbyIdModel.status;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<JionUsCubit, JionUsState>(
