...
class MangersDataSource extends DataGridSource {
  ...
  MangersDataSource(
      {required List<MangersModel> MangersList,
    ...
    dataGridRows =
        MangersList.map<DataGridRow>((dataGridRow) => DataGridRow(cells: [
          DataGridCell<int>(columnName: 'index', value: index++),
          DataGridCell<String>(columnName: 'name', value: dataGridRow.name),
          DataGridCell<String>(columnName: 'User Name', value: dataGridRow.userName),
          ...
          DataGridCell<String>(columnName: 'User Type', value: dataGridRow.userType),
          DataGridCell<String>(columnName: 'Created At', value: dataGridRow.CreatedAt),
