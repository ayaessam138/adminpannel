...
class CommnQuestionsDataSource extends DataGridSource {
  ...
  CommnQuestionsDataSource(
      {required List<CommnQuestionsModel> CommnQuestionsList,
    ...
    dataGridRows =
        CommnQuestionsList.map<DataGridRow>((dataGridRow) => DataGridRow(cells: [
