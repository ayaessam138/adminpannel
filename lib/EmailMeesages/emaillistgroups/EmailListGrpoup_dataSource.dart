...
class EmailListGrpoupDataSource extends DataGridSource {
  ...
  EmailListGrpoupDataSource(
      {required List<EmailListGrpoupModel> EmailListGrpoupList,
    ...
    dataGridRows =
        EmailListGrpoupList.map<DataGridRow>((dataGridRow) => DataGridRow(cells: [
          DataGridCell<int>(columnName: 'index', value: index++),
          DataGridCell<int>(columnName: 'id', value: dataGridRow.id),

          DataGridCell<String>(columnName: 'Groupname', value: dataGridRow.Groupname),
